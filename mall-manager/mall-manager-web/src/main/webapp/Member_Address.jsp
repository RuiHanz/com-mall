...
<%@ page import="com.mall.user.address" %>
<html >
<head>
<meta charset="UTF-8">
    <title>收货地址</title>
	...
	<div class="m_content">
   		<div class="m_left">
			...
			<div class="left_m">
				...
				<ul>
					<li><a href="Member.jsp">用户信息</a></li>
					<li><a href="Member_Collect.jsp">我的购物车</a></li>
					<li><a href="Member_Links.jsp">我的评论</a></li>
				</ul>
			</div>
		...
		<div class="m_right">
			...
			<div class="address">
            	...
            	<table border="1" class="add_t" align="center" style="width:98%; margin:10px auto;" cellspacing="0" cellpadding="0" >
                  ...
                  <tr>
                    <td>杨杨</td>
					  <td>四川成都市武侯区三环以内科华北路66号世外桃源写字楼3楼</td>
					  <td>12345678998</td>
					  <td>是</td>
                  </tr>
                    <% address orderlist =(address) request.getAttribute("addlist"); %>
                    <c:forEach items="${orderlist}" begin="0" end="4" step="4" var="stu">
                        <tr>
                            <td><font color="#ff4e00">${stu.shjr}</font></td>
                            <td>${stu.dz_mch}</td>
                            <td>${stu.lxfsh}</td>

                            <td><font color="#ff4e00">${stu.dzzt}</font></td>
                        </tr>
                    </c:forEach>
            ...
            <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="right">收货人姓名</td>
                <td style="font-family:'宋体';"><input type="text" value="姓名" class="add_ipt" /></td>
              </tr>
              <tr>
                <td align="right">详细地址</td>
              ...
              <tr>
                <td align="right">手机</td>
                <td style="font-family:'宋体';"><input type="text" value="1361234587" class="add_ipt" /></td>
              </tr>
            </table>
           	<p align="right">
