        ...
        <div class="w3ls-header-right">
            <ul>
                <li class="dropdown head-dpdn" style="color:#FFFFFF ">
                    <c:if test="${sessionScope.userName!=null}" var="flag11">
                        欢迎您，${sessionScope.userName}!
                    </c:if>
                    <c:if test="${not flag11}">
    ...
    <div class="header-two"><!-- header-two -->
        <div class="container">
            <div class="header-logo">
                <h1 style="font-size: 3em;font-weight: 900;"><a href="index.jsp" style="display: inline-block;color: #000;text-decoration: none; position: relative;"><span style="font-family: 'Lovers Quarrel', cursive; font-size: 2em; color:#F44336; vertical-align: sub;margin-right: 3px;">海</span>哥 <i style=" display: block;  position: absolute; bottom: 18%; right: 2%; font-size: 0.5em; ">电脑城</i></a></h1>
                <h6>你的商店，你做主</h6>
            </div>
    ...
    <div class="m_content">
        ...
        <div class="m_right">
            ...
            <div class="address">
                ...
                <table border="1" class="add_t" align="center" style="width:98%; margin:10px auto;" cellspacing="0" cellpadding="0" >
                    <thead>
                    ...
                    <c:forEach items="${addList}" var="stu">
                        <tr>
                            <td style="height: 30px"><font >${stu.shjr}</font></td>
                            <td>${stu.dz_mch}</td>
                            <td>${stu.lxfsh}</td>

                            <td><a href="/deleteAddress.do?dz_id=${stu.dz_id}" >删除</a></td>
                        </tr>
                    </c:forEach>
            ...
            <form method="post" action="/addAddress.do">
                收货人姓名：<input type="text" name="shhrName"></br>
                详细地址：<select id="province" name="province" onchange="selectCity()"></select>
                <select id="city" name="city" onchange="selectArea()"></select>
