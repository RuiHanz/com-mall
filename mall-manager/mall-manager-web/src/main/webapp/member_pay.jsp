        ...
        <div class="m_right">
            ...
            <c:set var="money" value="0"/>
                ...
                <div id="prods">
                    ...
                    <form action="/pay.do?&gwc_id=${carlist.gwc_id}&shp_mch=${carlist.shp_mch}" method="post">
                            <%--<input name="prodC" type="checkbox" value="" onclick=""/>--%>

                            <span id="prods_name">${carlist.shp_mch}</span>
                            <span id="prods_price">${carlist.shp_jg}</span>
                            <span id="prods_buynum">${carlist.shp_shl}</span>
                            <span id="prods_xiaoji">${carlist.shp_jg*carlist.shp_shl}</span>
                            <c:set var="money" value="${money+carlist.shp_jg*carlist.shp_shl}"/>
                        </c:forEach>

                            <select name="dz">
                                <c:forEach items="${addList}" var="alist">
                                    <option >${alist.dz_id}</option>
                                </c:forEach>
                            </select>
