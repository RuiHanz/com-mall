				...
				<div class="products-row">
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Leather Jacket</a></h5>
								<h6><del>$25</del> $20</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/f2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Women Sandal</a></h5>
								<h6><del>$22</del> $20</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/f3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<ul>
						...
						<li><a href="products.jsp">Beauty Gift Hampers</a></li>
