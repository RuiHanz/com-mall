...
<%@ page import="com.mall.user.Comments" %>
<html >
<head>
<meta charset="UTF-8">
    <title>分成明细</title>
		...
		<div class="m_right">
			...
			<table border="0" class="order_tab" style="width:930px; text-align:center; margin-bottom:30px;" cellspacing="0" cellpadding="0">
              <tr>                                                                                                                                                    
                ...
                <% Comments orderlist =(Comments) request.getAttribute("commentslist"); %>
                <c:forEach items="${orderlist}" begin="0" end="4" step="4" var="stu">
                    <tr>
                        <td><font color="#ff4e00">${stu.sh_mch}</font></td>
                        <td>${stu.pl_shj}</td>

                        <td><font color="#ff4e00">${stu.plnr}</font></td>
                    </tr>
                </c:forEach>
