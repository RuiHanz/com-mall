		...
		<div class="container">
				...
				<div class="products-row">
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/p1.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Coffee Mug</a></h5>
								<h6><del>$16</del> $14</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/p2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Teddy bear</a></h5>
								<h6><del>$25</del> $20</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/p3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Chocolates</a></h5>
								<h6><del>$80</del> $60</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/p4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Gift Card</a></h5>
								<h6><del>$25</del> $22</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<ul>
						<li><a href="products.jsp">Shelf Animation</a></li>
						<li><a href="products.jsp">Flowers</a></li>
						<li><a href="products.jsp">Dry Fruits</a></li>
						<li><a href="products.jsp">Mounted Photos</a></li>
						<li><a href="products.jsp">Decorative Plants</a></li>
						<li><a href="products.jsp">Best Priced</a></li>
						<li><a href="products.jsp">Sweets</a></li>
						<li><a href="products.jsp">Chocolates</a></li>
						<li><a href="products.jsp">3D-Rendered</a></li>
						<li><a href="products.jsp">Cards & Toys</a></li>
					</ul>
				</div>
				<div class="related-row">
