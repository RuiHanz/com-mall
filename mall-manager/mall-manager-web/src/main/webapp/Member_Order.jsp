...
<%@ page import="com.mall.user.order" %>
<html >
<head>
<meta charset="UTF-8">
    <title>我的订单</title>
		...
		<div class="m_right">
            ...
            <table border="0" class="order_tab" style="width:930px; text-align:center; margin-bottom:30px;" cellspacing="0" cellpadding="0" >
              <tr>                                                                                                                                                    
                ...
                <% order  orderlist =(order) request.getAttribute("orderlist"); %>
                <c:forEach items="${orderlist}" begin="0" end="5" step="6" var="stu">
                    <tr>
                    <td><font color="#ff4e00">${stu.dd_id}</font></td>
                    <td>${stu.chjshj}</td>
                    <td>${stu.zje}</td>
                    <td>${stu.jdh}</td>
                        <td>${stu.shp_mch}</td>
                    <td><font color="#ff4e00">${stu.shhr}</font></td>
                        <td><button type="button" value="写评论" href="comment.jsp">写评论</button></button> </td>
                    </tr>
                </c:forEach>
            </table>
        </div>
