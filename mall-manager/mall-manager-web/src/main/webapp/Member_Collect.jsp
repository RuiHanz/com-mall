...
<%@ page import="com.mall.user.Shopingcar" %>
<html >
<head>
<meta charset="UTF-8">
    <title>我的收藏</title>
		...
		<div class="m_right">
            <p></p>
              ...
              <tr>                                                                                                                                       
                ...
                <td align="center" width="10%">卖家名称</td>
                  <td align="center" width="40%">商品详情</td>
                  <td align="center" width="10%">商品颜色</td>
                  <td align="center" width="10%">商品数量</td>
                  <td align="center" width="10%">是否删除</td>
              </tr>
                    <% Shopingcar orderlist =(Shopingcar) request.getAttribute("shopList"); %>
                    <c:forEach items="${orderlist}" begin="0" end="5" step="6" var="stu">
                 <tr>
                    <td><font color="#ff4e00">${stu.shp_mch}</font></td>
                     <td>${stu.mai_mch}</td>
                     <td>${stu.shp_msh}</td>
                        <td>${stu.shp_ys}</td>
                    <td>${stu.shp_shl}</td>
                     <td>${stu.shp_jg}</td>
                     <td><button value="删除" type="button" name="delete">删除</button> </td>
                 </tr>
                    </c:forEach>
