		...
		<div class="container">
				...
				<div class="products-row">
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/f4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Party dress</a></h5>
								<h6><del>$20</del> $15</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/f1.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Lunch Box</a></h5>
								<h6><del>$20</del> $16</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Boys short</a></h5>
								<h6><del>$14</del> $12</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Jackets</a></h5>
								<h6><del>$32</del> $30</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<ul>
						<li><a href="products.jsp">Video Games</a></li>
						<li><a href="products.jsp">Casual Wear</a></li>
						<li><a href="products.jsp">Preschool Toys</a></li>
						<li><a href="products.jsp">T-Shirts</a></li>
						<li><a href="products.jsp">Blazers</a></li>
						<li><a href="products.jsp">Winter Wear</a></li>
						<li><a href="products.jsp">Shoes</a></li>
						<li><a href="products.jsp">Baby Care</a></li>
