		...
		<div class="container">
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<ul>
						<li><a href="products.jsp">Garage Storage</a></li>
						<li><a href="products.jsp">Casseroles</a></li>
						<li><a href="products.jsp">Living Room</a></li>
						<li><a href="products.jsp">Mattresses</a></li>
						<li><a href="products.jsp">Patio Tips</a></li>
						<li><a href="products.jsp">Patio Tips</a></li>
						<li><a href="products.jsp">Gardening</a></li>
						<li><a href="products.jsp">Furniture</a></li>
						<li><a href="products.jsp">Wall Decor</a></li>
						<li><a href="products.jsp">Floor Cleaning</a></li>
					</ul>
				</div>
				<div class="related-row">
