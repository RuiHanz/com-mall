    ...
    <%--<script type="text/javascript">
        ...
        $(function () {
            $.post({
                ...
                success:function (data) {
                    var pList =  JSON.parse(data);
                    var pSelect = $("#username");
                    pSelect.append(+pList[1]);
                }
            })
        });
        $(function () {
            $.post({
                ...
                success:function (data) {
                    var pList =  JSON.parse(data);
                    var pSelect = $("#userpaone");
                    pSelect.append(+pList[2]);
                }
            })
        });
        $(function () {
            $.post({
                ...
                success:function (data) {
                    var pList =  JSON.parse(data);
                    var pSelect = $("#usermail");
                    pSelect.append(+pList[3]);
                }
            })
        });
        $(function () {
            $.post({
                ...
                success:function (data) {
                    var pList =  JSON.parse(data);
                    var pSelect = $("#usercard");
                    pSelect.append(+pList[4]);
                }
            })
        });
        $(function () {
        ...
        <div class="m_right">
            ...
            <c:forEach items="${uList}" var="user">
                <tr>
                    ...
                    <td name="username">${user.yh_mch}</td>
                </tr>
                <tr>
                    <td class="td_l b_none">身份证号：</td>
                    <td name="usercard">${user.id_card}</td>
                </tr>
                <tr>
                    <td class="td_l b_none">电  话：</td>
                    <td name="userphone">${user.yh_shjh}</td>
                </tr>
                <tr>
                    <td class="td_l">邮   箱： </td>
                    <td name="usermail">${user.yh_yx}</td>
                </tr>
                <tr>
                    <td class="td_l b_none">性别</td>
                    <td name="usersex">${user.yh_xb}</td>
                </tr>
            </c:forEach>
