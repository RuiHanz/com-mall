						...
						<nav class="cd-dropdown"> 
							...
							<ul class="cd-dropdown-content"> 
								...
								<li class="has-children">
									...
									<ul class="cd-secondary-dropdown is-hidden">
										<li class="go-back"><a href="#">Menu</a></li>
										<li class="see-all"><a href="products9.jap">All Products</a></li>
										<li class="has-children">
											<a href="#">Books</a> 
											<ul class="is-hidden">
												<li class="go-back"><a href="#"></a></li>
												<li class="has-children"><a href="#">Exam books </a>
													<ul class="is-hidden">
														<li class="go-back"><a href="#"> </a></li>
														<li><a href="products9.jap">CAT/MAT/XAT</a></li>
														<li><a href="products9.jap">Civil Services</a></li>
														<li><a href="products9.jap">AFCAT</a></li>
														<li><a href="products9.jap">New Releases</a></li>
													</ul>												
												</li>
												<li><a href="products9.jap">Academic Text </a></li>
												<li><a href="products9.jap">Romance Books </a></li>
												<li><a href="products9.jap">Journals </a></li>
												<li><a href="products9.jap">Children's & Teen Books </a></li>
											</ul>
										</li> 
										<li class="has-children">
											<a href="#">Music</a> 
											<ul class="is-hidden">
												<li class="go-back"><a href="#"></a></li>
												<li><a href="products9.jap">New Releases </a></li>
												<li><a href="products9.jap">Country Music </a></li>
												<li><a href="products9.jap">Musical Instruments </a></li>
												<li><a href="products9.jap">Collections</a></li>
												<li><a href="products9.jap">Boxed Sets </a></li>
											</ul>
										</li> 
										<li class="has-children">
											...
											<ul class="is-hidden">
												<li class="go-back"><a href="#"></a></li>
												<li><a href="products9.jap">Pop </a></li>
												<li><a href="products9.jap">Preorders </a></li>
												<li><a href="products9.jap">Album Songs</a></li>
												<li><a href="products9.jap">Top 50 CDs </a></li>
												<li><a href="products9.jap">Music DVDs </a></li>
											</ul>
										</li>
										<li class="has-children">
											<a href="#">Movies</a> 
											<ul class="is-hidden"> 
												<li class="go-back"><a href="#"></a></li>
												<li><a href="products9.jap">New Releases </a></li>
												<li><a href="products9.jap">Children & Family </a></li>
												<li><a href="products9.jap">Action</a></li>
												<li><a href="products9.jap">Classic Movies </a></li>
												<li><a href="products9.jap">Bollywood Movies </a></li>
											</ul>
										</li> 
										<li class="has-children">
											...
											<ul class="is-hidden">
												<li class="go-back"><a href="#"></a></li>
												<li><a href="products9.jap">Hollywood Movies </a></li>
												<li><a href="products9.jap">Digital Movies </a></li>
												<li><a href="products9.jap">Boxed Sets</a></li>
												<li><a href="products9.jap">Animated</a></li>
												<li><a href="products9.jap">Adventure</a></li>
											</ul>
										</li> 
										<li class="has-children">
											<a href="#">TV Shows</a> 
											<ul class="is-hidden">
												<li class="go-back"><a href="#"></a></li>
												<li><a href="products9.jap">Serials</a></li>
												<li><a href="products9.jap">Best Programs</a></li>
												<li><a href="products9.jap">Celebrations</a></li>
												<li><a href="products9.jap">Top Shows</a></li>
											</ul>
										</li> 
									</ul><!-- .cd-secondary-dropdown --> 
								</li>  
		...
		<div class="container">
				...
				<div class="products-row">
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/m1.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Teens Book</a></h5>
								<h6><del>$10</del> $9</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/m2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Music CD</a></h5>
								<h6><del>$5</del> $4</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/m3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Movie DVD</a></h5>
								<h6><del>$8</del>$6</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/m4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Story Book</a></h5>
								<h6><del>$10</del> $8</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<ul>
						<li><a href="products.jsp">Civil Services</a></li>
						<li><a href="products.jsp">Academic Text</a></li>
						<li><a href="products.jsp">Music DVDs</a></li>
						<li><a href="products.jsp">Hollywood Movies</a></li>
						<li><a href="products.jsp">New Releases</a></li>
						<li><a href="products.jsp">Best Programs</a></li>
						<li><a href="products.jsp">Album Songs</a></li>
						<li><a href="products.jsp">Pop</a></li>
						<li><a href="products.jsp">Country Music</a></li>
						<li><a href="products.jsp">Journals</a></li>
					</ul>
				</div>
				<div class="related-row">
