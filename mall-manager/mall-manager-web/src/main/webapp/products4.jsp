		...
		<div class="container">
				...
				<div class="products-row">
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/s1.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Roller Skates</a></h5>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/s3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Nylon Shuttle</a></h5>
								<h6><del>$60</del> $56</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/s2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Football</a></h5>
								<h6><del>$71</del>$70</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.jsp"><img src="images/s5.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Exercise Bike</a></h5>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>OFF</h6></div>
							<a href="single.jsp"><img src="images/s4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.jsp">Cricket Kit</a></h5>
								<h6><del>$82</del> $80</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<ul>
						<li><a href="products.jsp">Travel Bags</a></li>
						<li><a href="products.jsp">Health Drinks</a></li>
						<li><a href="products.jsp">Lights & Lanterns</a></li>
						<li><a href="products.jsp">Body Massagers</a></li>
						<li><a href="products.jsp">Musical Instruments</a></li>
						<li><a href="products.jsp">Health Monitors</a></li>
						<li><a href="products.jsp">Shoes</a></li>
						<li><a href="products.jsp">Sports Apparel</a></li>
						<li><a href="products.jsp">Badminton</a></li>
						<li><a href="products.jsp">Shooting</a></li>
					</ul>
				</div>
				<div class="related-row">
